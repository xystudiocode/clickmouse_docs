...
<style>
    .about {
        content: url('/imgs/features/en/light/about.png')
    }

    .dark .about {
        content: url('/imgs/features/en/dark/about.png')
    }
</style>
...
Default opened URL is the `Documentation Link` in settings, default is [link](https://xystudiocode.github.io/clickmouse_docs/)`https://xystudiocode.github.io/clickmouse_docs/`
