...
| In English mode, dragging response delay, total delay prompt becomes Chinese | None | >=3.1.2.17 | None | Already fixed in beta version | [Issue Link](https://github.com/xystudiocode/pyClickMouse/issues/121) |
